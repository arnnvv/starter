...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "starter_email_verification_request" ADD CONSTRAINT "starter_email_verification_request_user_id_starter_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."starter_users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
